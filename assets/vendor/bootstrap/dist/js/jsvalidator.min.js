! function(e) {
    ...
    e.fn.jbvalidator = function(t) {
        ...
        let r = function(t, i) { let r = i || ""; return l = 0, e(t || a).find(n).each(((e, t) => { o(t, r) })), l },
            ...
            c = function(a) { e(a).removeClass(t.invalidClass), t.successClass && e(a).addClass(t.validClass) },
            f = {
                ...
                equal: function(t) { let a = e(t).data("vEqual"); if (a) { let n = e(a).attr("title"); if (e(a).val() !== e(t).val()) return i.equal.sprintf(n || "") } return "" },
                groupCheckBox: function(t, a) {
                    if (p(t, "type", "checkbox")) {
                        ...
                        if (n && (void 0 !== a.originalEvent && "input" === a.originalEvent.type && e(n).find("input[type=checkbox]").each(((t, a) => { e(a).trigger("input") })), r < l && (s || r > 0) && !1 === e(t).prop("checked"))) return i.groupCheckBox.sprintf(l)
                    }
                    return ""
                },
        ...
        function p(t, a, i = "") { let n = e(t).attr(a); if (void 0 !== n && !1 !== n) { if (!i) return !0; if (i === n) return !0 } return !1 }
        return String.prototype.sprintf = function() {
            ...
            return e
        }, s(), { validator: f, errorTrigger: function(e, t) { "object" == typeof e && (e = e[0]), e.setCustomValidity(t), u(e, e.validationMessage) }, reload: function() { s() }, checkAll: r }
    }
}(jQuery);