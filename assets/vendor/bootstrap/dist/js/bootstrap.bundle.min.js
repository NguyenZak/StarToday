...
!(function(t, e) {
        ...
        return i &&
            ...
            (function(t) {
                ...
                if (-1 !== navigator.userAgent.indexOf("Trident") &&
                    ...
                    return null;
                for (
                    var i = wt(t); ht(i) && ["html", "body"].indexOf(lt(i)) < 0;
        ...
        var i = e,
            ...
            y = (function(t, e, i) {
                var n =
                    ...
                    (function(t) {
                        var e = $t(wt(t)),
                            i = ["absolute", "fixed"].indexOf(bt(t).position) >= 0 &&
                            ht(t) ?
                            Tt(t) :
                            t;
                        return dt(i) ?
                    ...
                    r = rt.reduce(function(t, i) {
                        return (
                            (t[i] = (function(t, e, i) {
                                ...
                                return (
                                    (r = r || 0),
                                    (a = (a || 0) * s), [nt, it].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a }
                                );
                            })(i, e.rects, o)),
                            t
                        );
    ...
    function se(t, e, i) {
        ...
        return (
            ...
            (("body" !== lt(e) || Ut(o)) &&
                (l =
                    (n = e) !== ct(n) && ht(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } :
                    qt(n)),
                ht(e) ?
